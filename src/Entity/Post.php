...
class Post
{
    ...
    {
        return $this->count_repost;
    }

    public function setCountRepost(int $count_repost): static
    {
        $this->count_repost = $count_repost;
    ...
    public function setCountLike(int $count_like): static
    {
